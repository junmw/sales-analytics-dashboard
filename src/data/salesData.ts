...
// ponytail: native string parsing avoids external CSV library
export function parseSalesCsv(csvString: string): SaleRecord[] {
...
export const INITIAL_DATA: SaleRecord[] = parseSalesCsv(RAW_CSV_DATA);
...
export const ALL_PRODUCTS: string[] = Array.from(
  new Set(INITIAL_DATA.map((r) => r.product))
).sort();
